 ...
 * Pila
 *****Descripción**********************************************************
 * Es la clase que se encarga de administrar las estructuras de tipo pila
 *****Atributos************************************************************
 * char *apNombre
 * char *apTipo
 * Elemento *apElemento
...
class Pila{
	...
	public:
		 ...
		 ***********************************************************************************/
		Pila(char *pNombre,char *pTipo,Elemento *pElemento,bool enlazamiento,bool circularidad,bool insercionFin,bool insercionOrd){
			apNombre = pNombre;
			apTipo = pTipo;
		 ...
		 * menuPila
		 *****Descripción***************************************************
		 * Es el menu de las acciones que puede realizar la estructura Pila
		 *****Retorno*******************************************************
		 * 
		 *****Entradas******************************************************
		 * 
		...
		void verificarEliminar(){
			...
			cout<<"\nSe elimino el ultimo elemento en ser ingresado a la estructura"<<endl;
			mostrarElementos();
		}
				...
				while (temp != nullptr){
					...
					if (compare(temp->getAcceso(),(char*)"rw")){
						...
						if (compare(instruccion, (char*)"1")){
							...
							cout<<"El valor que eligio no es valido. Se denominara como false"<<endl;
							valor = false;
						}
					}
